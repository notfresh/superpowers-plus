...
digraph process {
    ...
    "Offer done-sink reflection" -> "Use superpowers:done-sink" [label="user agrees"];
    "Use superpowers:done-sink" -> "Use superpowers:finishing-a-development-branch";
    "Offer done-sink reflection" -> "Use superpowers:finishing-a-development-branch" [label="skip"];
}
```
